    ...
    HRESULT APIENTRY Adapter::GetCaps(_In_ D3D10DDI_HADAPTER hAdapter, _In_ const D3D10_2DDIARG_GETCAPS* pArgs)
    {
        ...
        switch (pArgs->Type)
        {
            ...
            case D3D10_2DDICAPS_TYPE::D3DWDDM2_0DDICAPS_D3D11_OPTIONS2:
            {
                ...
                static_assert(D3D12_CONSERVATIVE_RASTERIZATION_TIER_NOT_SUPPORTED == D3DWDDM2_0DDI_CONSERVATIVE_RASTERIZATION_NOT_SUPPORTED);
                static_assert(D3D12_CONSERVATIVE_RASTERIZATION_TIER_1        == D3DWDDM2_0DDI_CONSERVATIVE_RASTERIZATION_TIER_1);
                static_assert(D3D12_CONSERVATIVE_RASTERIZATION_TIER_2        == D3DWDDM2_0DDI_CONSERVATIVE_RASTERIZATION_TIER_2);
                static_assert(D3D12_CONSERVATIVE_RASTERIZATION_TIER_3        == D3DWDDM2_0DDI_CONSERVATIVE_RASTERIZATION_TIER_3);
                ...
                static_assert(D3D12_ASTC_PROFILE_NOT_SUPPORTED  == D3DWDDM2_0DDI_ASTC_PROFILE_NOT_SUPPORTED);
                static_assert(D3D12_ASTC_PROFILE_LDR            == D3DWDDM2_0DDI_ASTC_PROFILE_LDR_SUPPORTED);
                static_assert(D3D12_ASTC_PROFILE_HDR            == D3DWDDM2_0DDI_ASTC_PROFILE_HDR_SUPPORTED);
                static_assert(D3D12_ASTC_PROFILE_FULL           == D3DWDDM2_0DDI_ASTC_PROFILE_FULL_SUPPORTED);
